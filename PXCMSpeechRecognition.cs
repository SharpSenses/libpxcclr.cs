...
public class PXCMSpeechRecognition : PXCMBase {
    ...
    internal static extern pxcmStatus PXCMSpeechRecognition_BuildGrammarFromStringList(IntPtr voice, int gid,
        string[] cmds, int[] labels, int ncmds);
    ...
    [DllImport("libpxccpp2c", CharSet = CharSet.Unicode)]
    internal static extern pxcmStatus PXCMSpeechRecognition_BuildGrammarFromFile(IntPtr voice, int gid,
        GrammarFileType fileType, string grammarFilename);

    [DllImport("libpxccpp2c")]
    internal static extern pxcmStatus PXCMSpeechRecognition_BuildGrammarFromMemory(IntPtr voice, int gid,
        GrammarFileType fileType, byte[] grammaryMemory, int memSize);

    [DllImport("libpxccpp2c", CharSet = CharSet.Unicode)]
    private static extern void PXCMSpeechRecognition_GetGrammarCompileErrors(IntPtr voice, int gid, StringBuilder error,
        int nchars);
    ...
    [DllImport("libpxccpp2c", CharSet = CharSet.Unicode)]
    internal static extern pxcmStatus PXCMSpeechRecognition_AddVocabToDictation(IntPtr voice, VocabFileType fileType,
    ...
    public class AlertData {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 6)] internal int[] reserved;
    ...
    public class ProfileInfo {
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 128)] public string speaker;
        public LanguageType language;
        public int endOfSentence;
        public int threshold;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 13)] internal int[] reserved;
