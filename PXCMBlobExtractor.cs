...
public class PXCMBlobExtractor : PXCMBase {
    ...
    [DllImport("libpxccpp2c")]
    private static extern pxcmStatus PXCMBlobExtractor_QueryBlobData(IntPtr instance, int index,
        IntPtr segmentationImage, [Out] BlobData blobData);

    internal static pxcmStatus QueryBlobDataINT(IntPtr instance, int index, IntPtr segmentationImage,
        out BlobData blobData) {
