...
public class PXCMProjection : PXCMBase
{
  ...
  internal static extern pxcmStatus PXCMProjection_MapDepthToColor(IntPtr p, int npoints, PXCMPoint3DF32[] pos_uvz, [Out] PXCMPointF32[] pos_ij);

  [DllImport("libpxccpp2c")]
  internal static extern pxcmStatus PXCMProjection_MapColorToDepth(IntPtr p, IntPtr depth, int npoints, PXCMPointF32[] pos_ij, [Out] PXCMPointF32[] pos_uv);

  [DllImport("libpxccpp2c")]
  internal static extern pxcmStatus PXCMProjection_ProjectDepthToCamera(IntPtr p, int npoints, PXCMPoint3DF32[] pos_uvz, [Out] PXCMPoint3DF32[] pos3d);

  [DllImport("libpxccpp2c")]
  internal static extern pxcmStatus PXCMProjection_ProjectColorToCamera(IntPtr p, int npoints, PXCMPoint3DF32[] pos_ijz, [Out] PXCMPoint3DF32[] pos3d);

  [DllImport("libpxccpp2c")]
  internal static extern pxcmStatus PXCMProjection_ProjectCameraToDepth(IntPtr p, int npoints, PXCMPoint3DF32[] pos3d, [Out] PXCMPointF32[] pos_uv);

  [DllImport("libpxccpp2c")]
  internal static extern pxcmStatus PXCMProjection_ProjectCameraToColor(IntPtr p, int npoints, PXCMPoint3DF32[] pos3d, [Out] PXCMPointF32[] pos_ij);
  ...
  {
    IntPtr imageMappedToDepth = PXCMProjection_CreateColorImageMappedToDepth(instance, depth.instance, color.instance);
  ...
  {
    IntPtr imageMappedToColor = PXCMProjection_CreateDepthImageMappedToColor(instance, depth.instance, color.instance);
