...
public class PXCMSenseManager : PXCMBase
{
  ...
  [DllImport("libpxccpp2c")]
  internal static extern pxcmStatus PXCMSenseManager_StreamFrames(IntPtr putil, [MarshalAs(UnmanagedType.Bool)] bool blocking);
  ...
  [DllImport("libpxccpp2c")]
  internal static extern pxcmStatus PXCMSenseManager_AcquireFrame(IntPtr putil, [MarshalAs(UnmanagedType.Bool)] bool ifall, int timeout);
  ...
  [DllImport("libpxccpp2c")]
  internal static extern void PXCMSenseManager_PauseModule(IntPtr putil, int cuid, [MarshalAs(UnmanagedType.Bool)] bool pause);
  ...
  {
    IntPtr instance = PXCMSenseManager_QuerySample(this.instance, mid);
  ...
  {
    IntPtr instance = PXCMSenseManager_QuerySession(this.instance);
    if (instance == IntPtr.Zero)
      return null;
  ...
  {
    IntPtr instance = PXCMSenseManager_QueryCaptureManager(this.instance);
    if (instance == IntPtr.Zero)
      return null;
  ...
  public PXCMBase QueryModule(int mid)
  {
    ...
    IntPtr instance = PXCMSenseManager_QueryModule(this.instance, mid);
    if (instance == IntPtr.Zero)
      return null;
  ...
  {
    IntPtr instance = PXCMSenseManager_QueryModule(this.instance, 826885971);
    if (instance == IntPtr.Zero)
      return null;
  ...
  {
    IntPtr instance = PXCMSenseManager_QueryModule(this.instance, 826884947);
    if (instance == IntPtr.Zero)
      return null;
  ...
  {
    IntPtr instance = PXCMSenseManager_QueryModule(this.instance, 1347306323);
    if (instance == IntPtr.Zero)
      return null;
  ...
  {
    IntPtr instance = PXCMSenseManager_QueryModule(this.instance, 1380667988);
    if (instance == IntPtr.Zero)
      return null;
  ...
  {
    IntPtr instance = PXCMSenseManager_QueryModule(this.instance, 1144209734);
    if (instance == IntPtr.Zero)
      return null;
  ...
  {
    IntPtr instance = PXCMSenseManager_QueryModule(this.instance, 1314147653);
    if (instance == IntPtr.Zero)
      return null;
  ...
  {
    IntPtr instance = PXCMSenseManager_QueryModule(this.instance, 1397443654);
    if (instance == IntPtr.Zero)
      return null;
  ...
  {
    IntPtr instance = PXCMSenseManager_QueryModule(this.instance, 1313751368);
    if (instance == IntPtr.Zero)
      return null;
  ...
  {
    IntPtr instance = PXCMSenseManager_QueryModule(this.instance, 1145916738);
    if (instance == IntPtr.Zero)
      return null;
  ...
  public pxcmStatus EnableStream(PXCMCapture.StreamType type, int width, int height, float fps)
  {
    ...
    PXCMVideoModule.StreamDesc streamDesc = ddesc.streams[type];
  ...
  {
    IntPtr instance = PXCMSenseManager_CreateInstance();
    PXCMSenseManager pxcmSenseManager = instance != IntPtr.Zero ? new PXCMSenseManager(instance, true) : null;
    if (pxcmSenseManager == null)
      return pxcmSenseManager;
    try
    {
      PXCMSession pxcmSession = pxcmSenseManager.QuerySession();
      if (pxcmSession == null)
        return pxcmSenseManager;
      try
      {
