...
public class PXCMBlobConfiguration : PXCMBase
{
  ...
  [DllImport("libpxccpp2c")]
  internal static extern pxcmStatus PXCMBlobConfiguration_SetSegmentationSmoothing(IntPtr instance, float smoothingValue);
  ...
  [DllImport("libpxccpp2c")]
  internal static extern pxcmStatus PXCMBlobConfiguration_EnableSegmentationImage(IntPtr instance, [MarshalAs(UnmanagedType.Bool)] bool enableFlag);
  ...
  [DllImport("libpxccpp2c")]
  internal static extern pxcmStatus PXCMBlobConfiguration_EnableContourExtraction(IntPtr instance, [MarshalAs(UnmanagedType.Bool)] bool enableFlag);
  ...
  [DllImport("libpxccpp2c")]
  internal static extern pxcmStatus PXCMBlobConfiguration_EnableStabilizer(IntPtr instance, [MarshalAs(UnmanagedType.Bool)] bool enableFlag);
