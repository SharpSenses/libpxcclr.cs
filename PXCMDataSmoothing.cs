...
public class PXCMDataSmoothing : PXCMBase {
    ...
    internal static extern IntPtr PXCMDataSmoothing_Create1DStabilizer(IntPtr instance, float stabilizeStrength,
    ...
    [DllImport("libpxccpp2c")]
    internal static extern IntPtr PXCMDataSmoothing_Create2DStabilizer(IntPtr instance, float stabilizeStrength,
        float stabilizeRadius);
    ...
    [DllImport("libpxccpp2c")]
    internal static extern IntPtr PXCMDataSmoothing_Create3DStabilizer(IntPtr instance, float stabilizeStrength,
        float stabilizeRadius);
    ...
    public Smoother1D Create1DStabilizer(float stabilizeStrength, float stabilizeRadius) {
        var instance = PXCMDataSmoothing_Create1DStabilizer(this.instance, stabilizeStrength, stabilizeRadius);
    ...
    public Smoother1D Create1DWeighted(float[] weights) {
        var instance = PXCMDataSmoothing_Create1DWeighted(this.instance, weights.Length, weights);
        if (!(instance == IntPtr.Zero)) {
            return new Smoother1D(instance, true);
        }
        return null;
    ...
    public Smoother1D Create1DWeighted(int numWeights) {
        var instance = PXCMDataSmoothing_Create1DWeighted(this.instance, numWeights, null);
        if (!(instance == IntPtr.Zero)) {
            return new Smoother1D(instance, true);
        }
        return null;
    ...
    public Smoother1D Create1DQuadratic(float smoothStrength) {
        var instance = PXCMDataSmoothing_Create1DQuadratic(this.instance, smoothStrength);
        if (!(instance == IntPtr.Zero)) {
            return new Smoother1D(instance, true);
        }
        return null;
    ...
    public Smoother1D Create1DSpring(float smoothStrength) {
        var instance = PXCMDataSmoothing_Create1DSpring(this.instance, smoothStrength);
        if (!(instance == IntPtr.Zero)) {
            return new Smoother1D(instance, true);
        }
        return null;
    ...
    public Smoother2D Create2DStabilizer(float stabilizeStrength, float stabilizeRadius) {
        var instance = PXCMDataSmoothing_Create2DStabilizer(this.instance, stabilizeStrength, stabilizeRadius);
        if (!(instance == IntPtr.Zero)) {
    ...
    public Smoother2D Create2DWeighted(float[] weights) {
        var instance = PXCMDataSmoothing_Create2DWeighted(this.instance, weights.Length, weights);
        if (!(instance == IntPtr.Zero)) {
            return new Smoother2D(instance, true);
        }
        return null;
    ...
    public Smoother2D Create2DWeighted(int numWeighted) {
        var instance = PXCMDataSmoothing_Create2DWeighted(this.instance, numWeighted, null);
        if (!(instance == IntPtr.Zero)) {
            return new Smoother2D(instance, true);
        }
        return null;
    ...
    public Smoother2D Create2DQuadratic(float smoothStrength) {
        var instance = PXCMDataSmoothing_Create2DQuadratic(this.instance, smoothStrength);
        if (!(instance == IntPtr.Zero)) {
            return new Smoother2D(instance, true);
        }
        return null;
    ...
    public Smoother2D Create2DSpring(float smoothStrength) {
        var instance = PXCMDataSmoothing_Create2DSpring(this.instance, smoothStrength);
        if (!(instance == IntPtr.Zero)) {
            return new Smoother2D(instance, true);
        }
        return null;
    ...
    public Smoother3D Create3DStabilizer(float stabilizeStrength, float stabilizeRadius) {
        var instance = PXCMDataSmoothing_Create3DStabilizer(this.instance, stabilizeStrength, stabilizeRadius);
        if (!(instance == IntPtr.Zero)) {
    ...
    public Smoother3D Create3DWeighted(float[] weights) {
        var instance = PXCMDataSmoothing_Create3DWeighted(this.instance, weights.Length, weights);
        if (!(instance == IntPtr.Zero)) {
            return new Smoother3D(instance, true);
        }
        return null;
    ...
    public Smoother3D Create3DWeighted(int numWeights) {
        var instance = PXCMDataSmoothing_Create3DWeighted(this.instance, numWeights, null);
        if (!(instance == IntPtr.Zero)) {
            return new Smoother3D(instance, true);
        }
        return null;
    ...
    public Smoother3D Create3DQuadratic(float smoothStrength) {
        var instance = PXCMDataSmoothing_Create3DQuadratic(this.instance, smoothStrength);
        if (!(instance == IntPtr.Zero)) {
            return new Smoother3D(instance, true);
        }
        return null;
    ...
    public Smoother3D Create3DSpring(float smoothStrength) {
        var instance = PXCMDataSmoothing_Create3DSpring(this.instance, smoothStrength);
        if (!(instance == IntPtr.Zero)) {
            return new Smoother3D(instance, true);
        }
        return null;
    ...
    public class Smoother1D : PXCMBase {
        ...
        [DllImport("libpxccpp2c")]
        internal static extern pxcmStatus PXCMDataSmoothing_Smoother1D_AddSample(IntPtr instance, float newSample,
            long timestamp);
    ...
    public class Smoother2D : PXCMBase {
        ...
        [DllImport("libpxccpp2c")]
        internal static extern pxcmStatus PXCMDataSmoothing_Smoother2D_AddSample(IntPtr instance, PXCMPointF32 newSample,
            long timestamp);

        [DllImport("libpxccpp2c")]
        internal static extern void PXCMDataSmoothing_Smoother2D_GetSample(IntPtr instance, long timestamp,
            out PXCMPointF32 sample);
    ...
    public class Smoother3D : PXCMBase {
        ...
        [DllImport("libpxccpp2c")]
        internal static extern pxcmStatus PXCMDataSmoothing_Smoother3D_AddSample(IntPtr instance,
            PXCMPoint3DF32 newSample, long timestamp);

        [DllImport("libpxccpp2c")]
        internal static extern void PXCMDataSmoothing_Smoother3D_GetSample(IntPtr instance, long timestamp,
            out PXCMPoint3DF32 sample);
