...
public class PXCMFaceData : PXCMBase {
    ...
    private static extern pxcmStatus PXCMFaceData_QueryAlertNameByID(IntPtr instance, AlertData.AlertType alertEvent,
        StringBuilder outAlertName);

    internal static pxcmStatus QueryAlertNameByIDINT(IntPtr instance, AlertData.AlertType alertEvent,
        out string outAlertName) {
        var outAlertName1 = new StringBuilder(30);
        var pxcmStatus = PXCMFaceData_QueryAlertNameByID(instance, alertEvent, outAlertName1);
    ...
    public Face[] QueryFaces() {
        ...
        var source = PXCMFaceData_QueryFaces(instance, out numDetectedFaces);
        if (source == IntPtr.Zero) {
            return null;
        }
        var destination = new IntPtr[numDetectedFaces];
        Marshal.Copy(source, destination, 0, numDetectedFaces);
        var faceArray = new Face[numDetectedFaces];
        for (var index = 0; index < numDetectedFaces; ++index) {
    ...
    [DllImport("libpxccpp2c")]
    internal static extern pxcmStatus PXCMFaceData_QueryFiredAlertData(IntPtr instance, int index,
    ...
    internal static extern bool PXCMFaceData_IsAlertFired(IntPtr instance, AlertData.AlertType alertEvent,
        [Out] AlertData alertData);
    ...
    [DllImport("libpxccpp2c")]
    [return: MarshalAs(UnmanagedType.Bool)]
    internal static extern bool PXCMFaceData_IsAlertFiredByFace(IntPtr instance, AlertData.AlertType alertEvent,
        int faceID, [Out] AlertData alertData);
    ...
    public Face QueryFaceByID(int faceId) {
        var instance = PXCMFaceData_QueryFaceByID(this.instance, faceId);
    ...
    public Face QueryFaceByIndex(int index) {
        var instance = PXCMFaceData_QueryFaceByIndex(this.instance, index);
        if (!(instance != IntPtr.Zero)) {
            return null;
        }
        return new Face(instance);
    ...
    public RecognitionModuleData QueryRecognitionModule() {
        var instance = PXCMFaceData_QueryRecognitionModule(this.instance);
        if (instance == IntPtr.Zero) {
            return null;
        }
    ...
    public class DetectionData {
        ...
        [DllImport("libpxccpp2c")]
        [return: MarshalAs(UnmanagedType.Bool)]
        internal static extern bool PXCMFaceData_DetectionData_QueryFaceAverageDepth(IntPtr instance,
            out float outFaceAverageDepth);

        [DllImport("libpxccpp2c")]
        [return: MarshalAs(UnmanagedType.Bool)]
        internal static extern bool PXCMFaceData_DetectionData_QueryBoundingRect(IntPtr instance,
            out PXCMRectI32 outBoundingRect);
    ...
    public class LandmarksData {
        ...
        internal static bool QueryPointsINT(IntPtr instance, out LandmarkPoint[] points) {
            var length = PXCMFaceData_LandmarksData_QueryNumPoints(instance);
            var num1 = Marshal.AllocHGlobal(Marshal.SizeOf(typeof (LandmarkPoint))*length);
            var flag = PXCMFaceData_LandmarksData_QueryPoints(instance, num1);
            if (flag) {
        ...
        [DllImport("libpxccpp2c")]
        [return: MarshalAs(UnmanagedType.Bool)]
        internal static extern bool PXCMFaceData_LandmarksData_QueryPoint(IntPtr instance, int index,
            [Out] LandmarkPoint outPoint);
        ...
        [DllImport("libpxccpp2c")]
        internal static extern int PXCMFaceData_LandmarksData_QueryNumPointsByGroup(IntPtr instance,
            LandmarksGroupType group);

        [DllImport("libpxccpp2c")]
        [return: MarshalAs(UnmanagedType.Bool)]
        internal static extern bool PXCMFaceData_LandmarksData_QueryPointsByGroup(IntPtr instance,
            LandmarksGroupType groupFlags, IntPtr outPoints);

        internal static bool QueryPointsByGroupINT(IntPtr instance, LandmarksGroupType group, out LandmarkPoint[] points) {
            var length = PXCMFaceData_LandmarksData_QueryNumPointsByGroup(instance, group);
            var num1 = Marshal.AllocHGlobal(Marshal.SizeOf(typeof (LandmarkPoint))*length);
            var flag = PXCMFaceData_LandmarksData_QueryPointsByGroup(instance, group, num1);
            if (flag) {
                points = new LandmarkPoint[length];
                var index = 0;
                var num2 = 0;
    ...
    public class PoseData {
        ...
        [DllImport("libpxccpp2c")]
        [return: MarshalAs(UnmanagedType.Bool)]
        internal static extern bool PXCMFaceData_PoseData_QueryPoseAngles(IntPtr instance,
            [Out] PoseEulerAngles outPoseEulerAngles);
        ...
        [DllImport("libpxccpp2c")]
        [return: MarshalAs(UnmanagedType.Bool)]
        internal static extern bool PXCMFaceData_PoseData_QueryPoseQuaternion(IntPtr instance,
            [Out] PoseQuaternion outPoseQuaternion);
        ...
        [DllImport("libpxccpp2c")]
        [return: MarshalAs(UnmanagedType.Bool)]
        internal static extern bool PXCMFaceData_PoseData_QueryHeadPosition(IntPtr instance,
            [Out] HeadPosition outHeadPosition);
        ...
        [DllImport("libpxccpp2c")]
        internal static extern void PXCMFaceData_PoseData_QueryRotationMatrix(IntPtr instance,
            [Out] double[] outRotationMatrix);
    ...
    public class Face {
        ...
        public DetectionData QueryDetection() {
            var instance = PXCMFaceData_Face_Detection(this.instance);
            if (!(instance == IntPtr.Zero)) {
        ...
        public LandmarksData QueryLandmarks() {
            var instance = PXCMFaceData_Face_QueryLandmarks(this.instance);
            if (!(instance == IntPtr.Zero)) {
        ...
        public PoseData QueryPose() {
            var instance = PXCMFaceData_Face_QueryPose(this.instance);
            if (!(instance == IntPtr.Zero)) {
        ...
        public ExpressionsData QueryExpressions() {
            var instance = PXCMFaceData_Face_QueryExpressions(this.instance);
            if (instance == IntPtr.Zero) {
                return null;
            }
        ...
        public RecognitionData QueryRecognition() {
            var instance = PXCMFaceData_Face_QueryRecognition(this.instance);
            if (instance == IntPtr.Zero) {
                return null;
            }
        ...
        public PulseData QueryPulse() {
            var instance = PXCMFaceData_Face_QueryPulse(this.instance);
            if (instance == IntPtr.Zero) {
                return null;
            }
    ...
    public class ExpressionsData {
        ...
        [DllImport("libpxccpp2c")]
        [return: MarshalAs(UnmanagedType.Bool)]
        internal static extern bool PXCMFaceData_ExpressionsData_QueryExpression(IntPtr instance, FaceExpression au,
            [Out] FaceExpressionResult auResult);
    ...
    public class RecognitionModuleData {
        ...
        [DllImport("libpxccpp2c")]
        [return: MarshalAs(UnmanagedType.Bool)]
        internal static extern bool PXCMFaceData_RecognitionModuleData_QueryDatabaseBuffer(IntPtr instance,
            [Out] byte[] buffer);
    ...
    public class LandmarkPointSource {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 10)] internal int[] reserved;
    ...
    public class LandmarkPoint {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 10)] public int[] reserved;
    ...
    public class HeadPosition {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 9)] internal int[] reserved;
