...
public class PXCMVideoModule : PXCMBase {
    ...
    [DllImport("libpxccpp2c")]
    internal static extern pxcmStatus PXCMVideoModule_ProcessImageAsync(IntPtr module, PXCMCapture.Sample sample,
        out IntPtr sp);
    ...
    public pxcmStatus ProcessImageAsync(PXCMCapture.Sample sample, out PXCMSyncPoint sp) {
        IntPtr sp1;
        var pxcmStatus = PXCMVideoModule_ProcessImageAsync(instance, sample, out sp1);
    ...
    public class DataDesc {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 120)] public DeviceCap[] devCaps;
        public PXCMCapture.DeviceInfo deviceInfo;
