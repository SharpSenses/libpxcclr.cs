...
public class PXCMCapture : PXCMBase {
    ...
    public Device CreateDevice(int didx) {
        var device = PXCMCapture_CreateDevice(instance, didx);
    ...
    public class Device : PXCMBase {
        ...
        [DllImport("libpxccpp2c")]
        private static extern pxcmStatus PXCMCapture_Device_QueryStreamProfileSet(IntPtr device, StreamType scope,
            int index, [Out] StreamProfileSet profiles);

        internal static pxcmStatus QueryStreamProfileSetINT(IntPtr device, StreamType scope, int index,
            out StreamProfileSet profiles) {
        ...
        [DllImport("libpxccpp2c")]
        internal static extern pxcmStatus PXCMCapture_Device_SetStreamProfileSet(IntPtr device,
            StreamProfileSet profiles);

        [DllImport("libpxccpp2c")]
        internal static extern pxcmStatus PXCMCapture_Device_QueryProperty(IntPtr device, Property label,
            out float value);

        [DllImport("libpxccpp2c")]
        private static extern pxcmStatus PXCMCapture_Device_QueryPropertyInfo(IntPtr device, Property label,
            [Out] PropertyInfo info);

        internal static PropertyInfo QueryPropertyInfoINT(IntPtr device, Property label) {
            var info = new PropertyInfo();
            var num = (int) PXCMCapture_Device_QueryPropertyInfo(device, label, info);
            return info;
        }

        [DllImport("libpxccpp2c")]
        internal static extern pxcmStatus PXCMCapture_Device_QueryPropertyAuto(IntPtr device, Property label,
            out bool ifauto);

        [DllImport("libpxccpp2c")]
        internal static extern pxcmStatus PXCMCapture_Device_SetPropertyAuto(IntPtr device, Property pty,
            [MarshalAs(UnmanagedType.Bool)] bool ifauto);
        ...
        [DllImport("libpxccpp2c")]
        internal static extern pxcmStatus PXCMCapture_Device_ReadStreamsAsync(IntPtr device, StreamType scope,
            [Out] IntPtr[] images, out IntPtr sp);
        ...
        public int QueryColorExposure() {
            var num1 = 0.0f;
            var num2 = (int) QueryProperty(Property.PROPERTY_COLOR_EXPOSURE, out num1);
            return (int) num1;
        }
        ...
        public bool QueryColorAutoExposure() {
            var ifauto = false;
            var num = (int) QueryPropertyAuto(Property.PROPERTY_COLOR_EXPOSURE, out ifauto);
            return ifauto;
        }

        public int QueryColorBrightness() {
            var num1 = 0.0f;
            var num2 = (int) QueryProperty(Property.PROPERTY_COLOR_BRIGHTNESS, out num1);
            return (int) num1;
        }
        ...
        public int QueryColorContrast() {
            var num1 = 0.0f;
            var num2 = (int) QueryProperty(Property.PROPERTY_COLOR_CONTRAST, out num1);
            return (int) num1;
        }
        ...
        public int QueryColorSaturation() {
            var num1 = 0.0f;
            var num2 = (int) QueryProperty(Property.PROPERTY_COLOR_SATURATION, out num1);
            return (int) num1;
        }
        ...
        public int QueryColorHue() {
            var num1 = 0.0f;
            var num2 = (int) QueryProperty(Property.PROPERTY_COLOR_HUE, out num1);
            return (int) num1;
        }
        ...
        public int QueryColorGamma() {
            var num1 = 0.0f;
            var num2 = (int) QueryProperty(Property.PROPERTY_COLOR_GAMMA, out num1);
            return (int) num1;
        }
        ...
        public int QueryColorWhiteBalance() {
            var num1 = 0.0f;
            var num2 = (int) QueryProperty(Property.PROPERTY_COLOR_WHITE_BALANCE, out num1);
            return (int) num1;
        }
        ...
        public bool QueryColorAutoWhiteBalance() {
            var ifauto = false;
            var num = (int) QueryPropertyAuto(Property.PROPERTY_COLOR_WHITE_BALANCE, out ifauto);
            return ifauto;
        }
        ...
        public int QueryColorSharpness() {
            var num1 = 0.0f;
            var num2 = (int) QueryProperty(Property.PROPERTY_COLOR_SHARPNESS, out num1);
            return (int) num1;
        }
        ...
        public int QueryColorBackLightCompensation() {
            var num1 = 0.0f;
            var num2 = (int) QueryProperty(Property.PROPERTY_COLOR_BACK_LIGHT_COMPENSATION, out num1);
            return (int) num1;
        }
        ...
        public int QueryColorGain() {
            var num1 = 0.0f;
            var num2 = (int) QueryProperty(Property.PROPERTY_COLOR_GAIN, out num1);
            return (int) num1;
        }
        ...
        public PowerLineFrequency QueryColorPowerLineFrequency() {
            var num1 = 0.0f;
            var num2 = (int) QueryProperty(Property.PROPERTY_COLOR_POWER_LINE_FREQUENCY, out num1);
        ...
        public PowerLineFrequency QueryColorPowerLineFrequencyDefaultValue() {
            return
                (PowerLineFrequency)
                    QueryPropertyInfoINT(instance, Property.PROPERTY_COLOR_POWER_LINE_FREQUENCY).defaultValue;
        }

        public bool QueryColorAutoPowerLineFrequency() {
            var ifauto = false;
            var num = (int) QueryPropertyAuto(Property.PROPERTY_COLOR_POWER_LINE_FREQUENCY, out ifauto);
            return ifauto;
        }
        ...
        public PXCMPointF32 QueryColorFieldOfView() {
            var pxcmPointF32 = new PXCMPointF32();
            var num1 = (int) QueryProperty(Property.PROPERTY_COLOR_FIELD_OF_VIEW, out pxcmPointF32.x);
            var num2 =
                (int)
                    QueryProperty(Property.PROPERTY_COLOR_FIELD_OF_VIEW | Property.PROPERTY_COLOR_EXPOSURE,
                        out pxcmPointF32.y);
            return pxcmPointF32;
        }
        ...
        public PXCMPointF32 QueryColorFocalLength() {
            var pxcmPointF32 = new PXCMPointF32();
            var num1 = (int) QueryProperty(Property.PROPERTY_COLOR_FOCAL_LENGTH, out pxcmPointF32.x);
            var num2 =
                (int)
                    QueryProperty(Property.PROPERTY_COLOR_FOCAL_LENGTH | Property.PROPERTY_COLOR_EXPOSURE,
                        out pxcmPointF32.y);
            return pxcmPointF32;
        }
        ...
        public float QueryColorFocalLengthMM() {
            var num1 = 0.0f;
            var num2 = (int) QueryProperty(Property.PROPERTY_COLOR_FOCAL_LENGTH_MM, out num1);
            return num1;
        }

        public PXCMPointF32 QueryColorPrincipalPoint() {
            var pxcmPointF32 = new PXCMPointF32();
            var num1 = (int) QueryProperty(Property.PROPERTY_COLOR_PRINCIPAL_POINT, out pxcmPointF32.x);
            var num2 =
                (int)
                    QueryProperty(Property.PROPERTY_COLOR_PRINCIPAL_POINT | Property.PROPERTY_COLOR_EXPOSURE,
                        out pxcmPointF32.y);
            return pxcmPointF32;
        }
        ...
        public ushort QueryDepthConfidenceThreshold() {
            var num1 = 0.0f;
            var num2 = (int) QueryProperty(Property.PROPERTY_DEPTH_CONFIDENCE_THRESHOLD, out num1);
            return (ushort) num1;
        }
        ...
        public float QueryDepthUnit() {
            var num1 = 0.0f;
            var num2 = (int) QueryProperty(Property.PROPERTY_DEPTH_UNIT, out num1);
            return num1;
        }
        ...
        public PXCMPointF32 QueryDepthFieldOfView() {
            var pxcmPointF32 = new PXCMPointF32();
            var num1 = (int) QueryProperty(Property.PROPERTY_DEPTH_FIELD_OF_VIEW, out pxcmPointF32.x);
            var num2 =
                (int)
                    QueryProperty(Property.PROPERTY_DEPTH_FIELD_OF_VIEW | Property.PROPERTY_COLOR_EXPOSURE,
                        out pxcmPointF32.y);
            return pxcmPointF32;
        }

        public PXCMRangeF32 QueryDepthSensorRange() {
            var pxcmRangeF32 = new PXCMRangeF32();
            var num1 = (int) QueryProperty(Property.PROPERTY_DEPTH_SENSOR_RANGE, out pxcmRangeF32.min);
            var num2 =
                (int)
                    QueryProperty(Property.PROPERTY_DEPTH_SENSOR_RANGE | Property.PROPERTY_COLOR_EXPOSURE,
                        out pxcmRangeF32.max);
            return pxcmRangeF32;
        }

        public PXCMPointF32 QueryDepthFocalLength() {
            var pxcmPointF32 = new PXCMPointF32();
            var num1 = (int) QueryProperty(Property.PROPERTY_DEPTH_FOCAL_LENGTH, out pxcmPointF32.x);
            var num2 =
                (int)
                    QueryProperty(Property.PROPERTY_DEPTH_FOCAL_LENGTH | Property.PROPERTY_COLOR_EXPOSURE,
                        out pxcmPointF32.y);
            return pxcmPointF32;
        }
        ...
        public float QueryDepthFocalLengthMM() {
            var num1 = 0.0f;
            var num2 = (int) QueryProperty(Property.PROPERTY_DEPTH_FOCAL_LENGTH_MM, out num1);
            return num1;
        }

        public PXCMPointF32 QueryDepthPrincipalPoint() {
            var pxcmPointF32 = new PXCMPointF32();
            var num1 = (int) QueryProperty(Property.PROPERTY_DEPTH_PRINCIPAL_POINT, out pxcmPointF32.x);
            var num2 =
                (int)
                    QueryProperty(Property.PROPERTY_DEPTH_PRINCIPAL_POINT | Property.PROPERTY_COLOR_EXPOSURE,
                        out pxcmPointF32.y);
            return pxcmPointF32;
        }
        ...
        public bool QueryDeviceAllowProfileChange() {
            var num1 = 0.0f;
            var num2 = (int) QueryProperty(Property.PROPERTY_DEVICE_ALLOW_PROFILE_CHANGE, out num1);
            return num1 != 0.0;
        }
        ...
        public MirrorMode QueryMirrorMode() {
            var num1 = 0.0f;
            var num2 = (int) QueryProperty(Property.PROPERTY_DEVICE_MIRROR, out num1);
        ...
        public int QueryIVCAMLaserPower() {
            var num1 = 0.0f;
            var num2 = (int) QueryProperty(Property.PROPERTY_IVCAM_LASER_POWER, out num1);
            return (int) num1;
        }
        ...
        public IVCAMAccuracy QueryIVCAMAccuracy() {
            var num1 = 0.0f;
            var num2 = (int) QueryProperty(Property.PROPERTY_IVCAM_ACCURACY, out num1);
        ...
        public int QueryIVCAMFilterOption() {
            ...
            if (QueryProperty(Property.PROPERTY_IVCAM_FILTER_OPTION, out num1) < pxcmStatus.PXCM_STATUS_NO_ERROR) {
                var num2 = (int) QueryProperty(Property.PROPERTY_COLOR_GAMMA | Property.PROPERTY_CUSTOMIZED, out num1);
            }
            return (int) num1;
        }

        public PropertyInfo QueryIVCAMFilterOptionInfo() {
            var propertyInfo = QueryPropertyInfoINT(instance, Property.PROPERTY_IVCAM_FILTER_OPTION);
        ...
        public pxcmStatus SetIVCAMFilterOption(int value) {
            var pxcmStatus = SetProperty(Property.PROPERTY_IVCAM_FILTER_OPTION, value);
        ...
        public int QueryIVCAMMotionRangeTradeOff() {
            float num1;
            if (QueryProperty(Property.PROPERTY_IVCAM_MOTION_RANGE_TRADE_OFF, out num1) <
                pxcmStatus.PXCM_STATUS_NO_ERROR) {
                var num2 =
                    (int) QueryProperty(Property.PROPERTY_COLOR_SATURATION | Property.PROPERTY_CUSTOMIZED, out num1);
            }
            return (int) num1;
        }

        public PropertyInfo QueryIVCAMMotionRangeTradeOffInfo() {
            var propertyInfo = QueryPropertyInfoINT(instance, Property.PROPERTY_IVCAM_MOTION_RANGE_TRADE_OFF);
            if (propertyInfo.range.max > 0.0) {
                return propertyInfo;
            }
        ...
        public pxcmStatus SetIVCAMMotionRangeTradeOff(int value) {
            var pxcmStatus = SetProperty(Property.PROPERTY_IVCAM_MOTION_RANGE_TRADE_OFF, value);
            if (pxcmStatus < pxcmStatus.PXCM_STATUS_NO_ERROR) {
        ...
        public bool QueryDSLeftRightCropping() {
            var num1 = 0.0f;
            var num2 = (int) QueryProperty(Property.PROPERTY_DS_CROP, out num1);
            return num1 != 0.0;
        }
        ...
        public bool QueryDSEmitterEnabled() {
            var num1 = 0.0f;
            var num2 = (int) QueryProperty(Property.PROPERTY_DS_EMITTER, out num1);
            return num1 != 0.0;
        }
        ...
        public float QueryDSTemperature() {
            var num1 = 0.0f;
            var num2 = (int) QueryProperty(Property.PROPERTY_DS_TEMPERATURE, out num1);
            return num1;
        }

        public bool QueryDSDisparityOutputEnabled() {
            var num1 = 0.0f;
            var num2 = (int) QueryProperty(Property.PROPERTY_DS_DISPARITY_OUTPUT, out num1);
            return num1 != 0.0;
        }
        ...
        public int QueryDSDisparityMultiplier() {
            var num1 = 0.0f;
            var num2 = (int) QueryProperty(Property.PROPERTY_DS_DISPARITY_MULTIPLIER, out num1);
            return (int) num1;
        }
        ...
        public int QueryDSDisparityShift() {
            var num1 = 0.0f;
            var num2 = (int) QueryProperty(Property.PROPERTY_DS_DISPARITY_SHIFT, out num1);
            return (int) num1;
        }
        ...
        public PXCMRangeF32 QueryDSMinMaxZ() {
            ...
            var num1 = (int) QueryProperty(Property.PROPERTY_DS_MIN_MAX_Z, out pxcmRangeF32.min);
            var num2 =
                (int)
                    QueryProperty(Property.PROPERTY_COLOR_WHITE_BALANCE | Property.PROPERTY_DS_CROP,
                        out pxcmRangeF32.max);
            return pxcmRangeF32;
        }

        public pxcmStatus SetDSMinMaxZ(PXCMRangeF32 value) {
            var pxcmStatus = SetProperty(Property.PROPERTY_DS_MIN_MAX_Z, value.min);
            if (pxcmStatus != pxcmStatus.PXCM_STATUS_NO_ERROR) {
        ...
        public bool QueryDSColorRectificationEnabled() {
            var num1 = 0.0f;
            var num2 = (int) QueryProperty(Property.PROPERTY_DS_COLOR_RECTIFICATION, out num1);
            return num1 != 0.0;
        }

        public bool QueryDSDepthRectificationEnabled() {
            var num1 = 0.0f;
            var num2 = (int) QueryProperty(Property.PROPERTY_DS_DEPTH_RECTIFICATION, out num1);
            return num1 != 0.0;
        }

        public float QueryDSLeftRightExposure() {
            var num1 = 0.0f;
            var num2 = (int) QueryProperty(Property.PROPERTY_DS_LEFTRIGHT_EXPOSURE, out num1);
            return num1;
        }
        ...
        public int QueryDSLeftRightGain() {
            var num1 = 0.0f;
            var num2 = (int) QueryProperty(Property.PROPERTY_DS_LEFTRIGHT_GAIN, out num1);
            return (int) num1;
        }
        ...
        public pxcmStatus ReadStreamsAsync(StreamType scope, Sample sample, out PXCMSyncPoint sp) {
            IntPtr sp1;
            var pxcmStatus = PXCMCapture_Device_ReadStreamsAsync(instance, scope, sample.images, out sp1);
        ...
        public pxcmStatus ReadStreams(StreamType scope, Sample sample) {
            PXCMSyncPoint sp;
            var pxcmStatus1 = ReadStreamsAsync(scope, sample, out sp);
            if (pxcmStatus1 < pxcmStatus.PXCM_STATUS_NO_ERROR) {
                return pxcmStatus1;
            }
            var pxcmStatus2 = sp.Synchronize();
            sp.Dispose();
            return pxcmStatus2;
        }

        public PXCMProjection CreateProjection() {
            var projection = PXCMCapture_Device_CreateProjection(instance);
        ...
        public class PropertyInfo {
            ...
            [MarshalAs(UnmanagedType.Bool)] public bool automatic;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 11)] internal int[] reserved;
    ...
    [StructLayout(LayoutKind.Sequential)]
    public class Sample {
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 8)] internal IntPtr[] images;
        ...
        public PXCMImage this[StreamType type] {
            get {
                var index = StreamTypeToIndex(type);
                if (images[index] == IntPtr.Zero) {
                    return null;
                }
                return new PXCMImage(images[index], false);
            }
            set { images[StreamTypeToIndex(type)] = value != null ? value.instance : IntPtr.Zero; }
        }
    ...
    public class DeviceInfo {
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 224)] public string name;
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 32)] public string serial;
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 256)] public string did;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 4)] public int[] firmware;
        ...
        public int didx;
        public int duid;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 4)] internal int[] reserved;
