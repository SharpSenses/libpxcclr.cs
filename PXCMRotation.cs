...
public class PXCMRotation : PXCMBase {
    ...
    [DllImport("libpxccpp2c")]
    internal static extern void PXCMRotation_SetFromSlerp(IntPtr instance, float factor, IntPtr startRotation_instance,
        IntPtr endRotation_instance);
    ...
    public void SetFromEulerAngles(PXCMPoint3DF32 eulerAngles, EulerOrder order) {
