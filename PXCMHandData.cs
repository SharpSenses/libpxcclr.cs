...
public class PXCMHandData : PXCMBase
{
  ...
  [DllImport("libpxccpp2c")]
  private static extern pxcmStatus PXCMHandData_QueryFiredAlertData(IntPtr instance, int index, [Out] AlertData alertData);
  ...
  private static extern bool PXCMHandData_IsAlertFired(IntPtr instance, AlertType alertEvent, [Out] AlertData alertData);
  ...
  [DllImport("libpxccpp2c")]
  [return: MarshalAs(UnmanagedType.Bool)]
  private static extern bool PXCMHandData_IsAlertFiredByHand(IntPtr instance, AlertType alertEvent, int handID, [Out] AlertData alertData);

  internal static bool IsAlertFiredByHandINT(IntPtr instance, AlertType alertEvent, int handID, out AlertData alertData)
  {
    alertData = new AlertData();
  ...
  [DllImport("libpxccpp2c")]
  private static extern pxcmStatus PXCMHandData_QueryFiredGestureData(IntPtr instance, int index, [Out] GestureData gestureData);
  ...
  [return: MarshalAs(UnmanagedType.Bool)]
  private static extern bool PXCMHandData_IsGestureFired(IntPtr instance, string gestureName, [Out] GestureData gestureData);
  ...
  [DllImport("libpxccpp2c", CharSet = CharSet.Unicode)]
  [return: MarshalAs(UnmanagedType.Bool)]
  private static extern bool PXCMHandData_IsGestureFiredByHand(IntPtr instance, string gestureName, int handID, [Out] GestureData gestureData);

  internal static bool IsGestureFiredByHandINT(IntPtr instance, string gestureName, int handID, out GestureData gestureData)
  {
    gestureData = new GestureData();
  ...
  [DllImport("libpxccpp2c")]
  internal static extern pxcmStatus PXCMHandData_QueryHandId(IntPtr instance, AccessOrderType accessOrder, int index, out int handId);

  [DllImport("libpxccpp2c")]
  internal static extern pxcmStatus PXCMHandData_QueryHandData(IntPtr instance, AccessOrderType accessOrder, int index, out IntPtr handData);
  ...
  {
    IntPtr handData1;
    pxcmStatus pxcmStatus = PXCMHandData_QueryHandData(instance, accessOrder, index, out handData1);
  ...
  {
    IntPtr handData1;
    pxcmStatus pxcmStatus = PXCMHandData_QueryHandDataById(instance, handId, out handData1);
    handData = pxcmStatus >= pxcmStatus.PXCM_STATUS_NO_ERROR ? new IHand(handData1) : null;
    return pxcmStatus;
  }
  ...
  public class IHand
  {
    ...
    {
      IntPtr image1;
      pxcmStatus pxcmStatus = PXCMHandData_IHand_QuerySegmentationImage(instance, out image1);
